...
export function ExhibitionPotentialSection() {
  return (
    <section
      ...
      className="relative isolate flex min-h-[38rem] items-center overflow-hidden bg-pawen-brand-color px-5 py-10 text-background sm:px-8 lg:min-h-[46rem] lg:px-10 lg:py-16"
    >
      <MotionReveal
        ariaHidden
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl justify-center">
        <div className="grid w-full gap-4 md:grid-cols-2 md:items-stretch">
          ...
          >
            ...
            <p className="font-brand text-sm leading-6 text-background md:text-lg md:leading-8 lg:text-base lg:leading-7 2xl:text-base 3xl:text-lg 3xl:leading-8">
          ...
          >
            ...
            <p className="font-brand text-sm leading-6 md:text-lg md:leading-8 lg:text-base lg:leading-7 2xl:text-base 3xl:text-lg 3xl:leading-8">
