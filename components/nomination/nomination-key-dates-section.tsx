...
const keyDates = [
  ...
  { label: 'Nominations Close:', value: '30th September 2026' },
  { label: 'Finalist Reveal', value: '21st October 2026' },
          ...
          <div className='grid gap-x-12 gap-y-6 sm:grid-cols-2 lg:grid-cols-3'>
            {keyDates.map((item, index) => (
              <MotionReveal
                ...
                key={item.label}
              >
                <h3 className='font-brand text-base font-medium leading-6 text-accent'>
                  {item.label}
                </h3>
